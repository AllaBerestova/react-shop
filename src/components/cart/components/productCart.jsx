        ...
        <div className="product-list">
            {productsCart.map((product) => (
                <div className="product" key={product.id} data-id={product.id}>
                    <div className="photo-cart"><img src={product.image} alt={product.name}/></div>
                        ...
                        <div className="price-wrapper">
                            <div className="price-and-quantity">
                                ...
                                <div className="quantity">
                                    <div className="count-button" onClick={removeProductCart}>-</div>
                                    <div className="count">{product.quantity}</div>
                                    <div className="count-button" onClick={addProductCart}>+</div>
                                </div>
                            </div>
                            <div className="total-price">{(product.price*product.quantity).toFixed(2)}</div>
                        </div>
                        <div className="close" onClick={deleteProductCart}>X</div>
                    </div>
                    </div>
                ))}
