    ...
    <>
      ...
      <div className="sidebar-content">
        <div className="price-bar">
          <input type="number" placeholder="0" className="input" value={minPrice} onChange={changeMinPrice} />
          <input type="number" placeholder="999999" className="input" value={maxPrice} onChange={changeMaxPrice} />
        </div>
      </div>
    </>
  );
